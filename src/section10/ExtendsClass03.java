 ...
 *  
 *  	이름충돌 방지 : 같은이름 패키지를 달리하여 충돌 방지 가능.
 ...
 * 		protected - 같은 패키지 or 상속 관계에서 접근 가능.
 * 		default - 같은 패키지 접근 가능.
 * 		private - 같은 클래서 안에서 접근 가능.
 * 
 * import
...
public class ExtendsClass03 {
	public static void main(String[] args) {
		...
		//protected 접근제한자 여서 다른패키지 접근 불가
		//System.out.println("가격 : " + book1.price + "원");
		//default 접근 제한자 여서 다른패키지 접근 불가
		//System.out.println("페이지 수 : " + book1.totalPage);
